...
//		text("Below 4.0", 75, 225);
		...
		font = createFont("Helvetica-Bold", 13);
		fill(0, 0, 0);
		textFont(font);
		...
		//white circle
		fill(255, 255, 255);
		ellipse(50, 190, 15, 15);

		fill(0, 0, 0);
		textFont(font);
		text("Land Quake", 75, 195);
	...
	private void printQuakes() 
	{
		...
		for (Marker cm : countryMarkers) {
			...
			if (quakes > 0) {
				System.out.println(countryName + " | " + quakes);
			}
		}
